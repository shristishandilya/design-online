    ...
    <section class="about-us">
        <div class="container py-3 py-md-4">
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active">E-Catelouge</span>
            </nav>
            <div>
                    <div class="mb-4">
                        <h2 class="pb-3 text-left bottom-line left">Our Catalogues</h2>
                    ...
                    <div class="row">
                        <div class="col-md-4 m-md-0 mb-3">
                            ...
                            <p class="mt-3">Allcor Color Core Decorative PVC Laminates 2019</p>
                            <button class="btn btn-white border-dark">Download PDF</button>
                        </div>
                        <div class="col-md-4 m-md-0 mb-3">
                            <img class="img-fluid mx-auto" data-src="holder.js/500x500/auto"
                                 alt="500x500"
